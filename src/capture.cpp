...
bool PacketCapture::startCapture(const std::string &interface, const std::string &filterExp = nullptr)
{
    ...
    // 如果没有提供过滤器表达式，则设置为一个空字符串
    std::string filterExpression = filterExp.empty() ? "" : filterExp;
